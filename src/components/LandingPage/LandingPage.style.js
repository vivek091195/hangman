...
export const Rectangle = styled.div`
    ...
    box-shadow: 0 8px 0 4px ${COLORS.BLUE.shade5}, inset 0 8px 0 2px ${COLORS.BLUE.shade2};
    border-radius: 72px;
    background-size: cover;
    background-position: center;
    background-repeat: no-repeat;
...
export const Circle = styled.div`
    ...
    border-radius: 50%;
    box-shadow: 0 4px 0 5px ${COLORS.BLUE.shade7}, inset 0 -8px 0 6px ${COLORS.PINK.shade2};
    cursor: pointer;
    position: absolute;
    top: 50%;
    left: 50%;
...
export const HowToPlayButton = styled.div`
    ...
    box-shadow: 0 2px 0 3px ${COLORS.BLUE.shade5}, inset 0 4px 0 3px ${COLORS.BLUE.shade8};
    position: absolute;
    top: 85%;
    left: 50%;
    transform: translateX(-50%);
